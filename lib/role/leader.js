    ...
    on_rpc(rpc) {
        ...
        if (rpc.message instanceof AppendEntriesRPCReply) {
            if (rpc.message.success) {
                ...
                this.match_index[rpc.sender] = this.next_index[rpc.sender]
                this.next_index[rpc.sender] = rpc.message.prevLogIndex + 2
            } else {
                this.next_index[rpc.sender] = rpc.message.prevLogIndex
            }
        }
        return null
    }
